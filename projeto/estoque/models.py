...
from projeto.produto.models import Fornecedor
...
class Estoque(TimeStampedModel):
    ...
    obs = models.CharField('Observação', max_length=222, null=True, blank=True)
...
class EstoqueItens(models.Model):
    ...
    preco_pro = models.DecimalField('preço', null=True, max_digits=7, decimal_places=2, blank=True)
    fornecedor = models.ForeignKey(
        Fornecedor,
        on_delete=models.SET_NULL,
        null=True,
