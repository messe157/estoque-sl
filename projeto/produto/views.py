...
def save_data(data):
    ...
    for item in data:
        ...
        verificado = True if item.get('verificado') == 'True' else False
...
def export_csv(request):
    header = (
        'verificado', 'ncm', 'produto', 'preco', 'estoque', 'estoque_minimo', 
    )
...
def exportar_produtos_xlsx(request):
    ...
    columns = ('Verificado', 'NCM', 'Produto', 'Preço',
               'Estoque', 'Estoque mínimo', 'Categoria', 'Fornecedor',)
